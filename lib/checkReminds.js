        ...
        event.once('end', function () {
            mailList.forEach(function(mail){
                mailParser.once("end",function(mail_object){
                    ...
                    logger.info("TO!!!!!!!!!!!!",mail_object.to);
                    logger.info("FROM!!!!!!!!!!!!",mail_object.from);
                    logger.info("TEXT:!!!!!!",mail_object.text);
                    var mail_object2 = {
                        to:"",from:"",subject:"",text:""
                    };
                    mail_object2.to=mail_object.to;
                    mail_object2.from=mail_object.from;
                    mail_object2.subject=subject;//mail_object.subject;
                    mail_object2.text=mail_object.text;
                    mailSender.sendMail(mail_object2, logger);
                    //mailItem=mail_object;
